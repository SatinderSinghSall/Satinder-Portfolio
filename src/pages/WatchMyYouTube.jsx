...
export default function WatchMyYouTube() {
  ...
  // Dynamic Current URL for SEO Canonical & Meta Tag
  const currentUrl = typeof window !== "undefined" ? window.location.href : "";

  // Dynamic ItemList Schema for rich Google search results
  const schemaData = useMemo(() => {
    return {
      ...
      description:
        "Curated video tutorials on full-stack web development, DSA, and tech insights.",
      ...
      itemListElement: paginatedVideos.map((video, index) => ({
        ...
        item: {
          ...
          contentUrl: video.videoUrl || `${currentUrl}/${video._id}`,
        },
      })),
    };
  }, [paginatedVideos, filteredVideos.length, currentUrl]);

  return (
    <>
      {/* Dynamic SEO Tags */}
      <Helmet>
        <title>Video Gallery & Tutorials | Watch My YouTube by Satinder Singh Sall</title>
        <meta
          name="description"
          content="Explore curated tutorials on full-stack web development, software engineering, DSA, mobile apps, and developer guides."
        />
        <meta
          name="keywords"
          content="web development, tutorials, react, full stack, coding, dsa, software engineering, youtube videos"
        />
        ...
        <meta
          property="og:title"
          content="Video Gallery & Tutorials | Watch My YouTube"
        />
        <meta
          property="og:description"
          content="Explore curated content on web development, tech insights, mobile app development, DSA, and tutorials — crafted for modern devs."
        />
        ...
        <meta
          ...
          content="Explore curated content on web development, tech insights, mobile app development, DSA, and tutorials."
        />
          ...
          <div className="flex flex-col gap-10">
            <div className="text-center">
              ...
              <p className="mt-5 text-gray-300 text-sm sm:text-lg max-w-3xl mx-auto leading-relaxed">
                Explore curated content on web development, tech insights,
                mobile app development, DSA, and tutorials — crafted for modern
                devs.
              </p>
            </div>
